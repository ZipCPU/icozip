...
static volatile unsigned *const _bustimer = ((unsigned *)0x00000400);
#endif	// BUSTIMER_ACCESS
#define	_BOARD_HAS_BUSERR
static volatile unsigned *const _buserr = ((unsigned *)1536);
#ifdef	BUSPIC_ACCESS
#define	_BOARD_HAS_BUSPIC
static volatile unsigned *const _buspic = ((unsigned *)1540);
#endif	// BUSPIC_ACCESS
#ifdef	GPIO_ACCESS
...
static volatile CONSOLE *const _uart = ((CONSOLE *)1280);
