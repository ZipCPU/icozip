...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga autofpga -o . global.txt bkram.txt buserr.txt clock.txt pic.txt pwrcount.txt version.txt hbconsole.txt gpio.txt dlyarbiter.txt zipbones.txt sramdev.txt
//
...
// check
	...
	// from
	localparam	RESET_ADDRESS = 32'h00010000;
	//
	// The number of valid bits on the bus
	localparam	ZIP_ADDRESS_WIDTH = 16; // Zip-CPU address width
	//
...
`include "builddate.v"
 ...
 // 0x0004
	assign	      wb_dio_sel = ((wb_addr[15:12] &  4'hf) ==  4'h1); // 0x4000 - 0x4007
//x2	Was a master bus as well
	assign	     console_sel = ((wb_addr[15:12] &  4'hf) ==  4'h2); // 0x8000 - 0x800f
	assign	      wb_sio_sel = ((wb_addr[15:12] &  4'hf) ==  4'h3); // 0xc000 - 0xc01f
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[15:12] &  4'hf) ==  4'h4); // 0x10000 - 0x100ff
	assign	        sram_sel = ((wb_addr[15:12] &  4'h8) ==  4'h8); // 0x20000 - 0x3ffff
	//
	...
	assign	      hb_dwb_sel = ((hb_addr[16:16] &  1'h1) ==  1'h0); // 0x00000 - 0x3ffff
//x2	Was a master bus as well
	assign	     zip_dbg_sel = ((hb_addr[16:16] &  1'h1) ==  1'h1); // 0x40000 - 0x40007
	//
...
`endif	// INCLUDE_ZIPCPU
	...
	assign	buserr_data = { {(32-2-16){1'b0}},
			r_buserr_addr, 2'b00 };
`ifdef	BUSPIC_ACCESS
	//
...
`ifdef	INCLUDE_ZIPCPU
	...
	wbpriarbiter #(32,16)	bus_arbiter(i_clk,
...
`else
	...
	assign	hb_dwbi_addr  = hb_addr[(16-1):0];
...
`ifdef	BUS_DELAY_NEEDED
	busdelay #(16)	hb_dwbi_delay(i_clk, i_reset,
		hb_dwbi_cyc, hb_dwbi_stb, hb_dwbi_we, hb_dwbi_addr, hb_dwbi_odata, hb_dwbi_sel,
...
`endif
	...
	hbconsole genbus(i_clk, pp_rx_stb, pp_rx_data,
			...
			w_console_rx_stb, w_console_rx_data);
	assign	hb_sel = 4'hf;
	assign	hb_addr= hb_tmp_addr[(17-1):0];
`else	// WBUBUS_MASTER
