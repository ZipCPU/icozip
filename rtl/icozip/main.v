...
//
	...
	// Wishbone slave definitions for bus wb, slave spixscope
	wire		spixscope_sel, spixscope_ack, spixscope_stall;
	wire	[31:0]	spixscope_data;
 ...
 // 0x000004
	...
	assign	   spixscope_sel = ((wb_addr[22:19] &  4'hf) ==  4'h2); // 0x400000 - 0x400007
...
`else	// FLASH_SCOPE
	...
	// In the case that there is no spixscope peripheral responding on the wb bus
	reg	r_spixscope_ack;
	initial	r_spixscope_ack = 1'b0;
	always @(posedge i_clk)	r_spixscope_ack <= (wb_stb)&&(spixscope_sel);
	assign	spixscope_ack   = r_spixscope_ack;
	assign	spixscope_stall = 0;
	assign	spixscope_data  = 0;
