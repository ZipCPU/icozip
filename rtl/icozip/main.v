...
//
	...
	// Wishbone slave definitions for bus wb, slave dbgscope
	wire		dbgscope_sel, dbgscope_ack, dbgscope_stall;
	wire	[31:0]	dbgscope_data;
 ...
 // 0x000004
	...
	assign	    dbgscope_sel = ((wb_addr[22:19] &  4'hf) ==  4'h2); // 0x400000 - 0x400007
...
`endif	// BKRAM_ACCESS
	...
	wbscope #(.LGMEM(6), .SYNCHRONOUS(1), .HOLDOFFBITS(3))
		dbgscopei(i_clk, 1'b1, dbgscoped[31], dbgscoped,
			i_clk, wb_cyc, (wb_stb)&&(dbgscope_sel),
			wb_we, wb_addr[0], wb_data,
			dbgscope_ack, dbgscope_stall, dbgscope_data,
			dbgscope_int);
