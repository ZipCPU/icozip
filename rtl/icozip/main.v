...
`include "builddate.v"
	...
	wire		flashcfg_sel, flashcfg_stall, flashcfg_ack;
	...
	wire		sram_sel, sram_stall, sram_ack;
	wire	[31:0]	sram_data;
	...
	assign	        gpio_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h2));  // 0x000008
...
//x2	Was a master bus as well
	...
	assign	        sram_sel = ((wb_addr[22:19] &  4'hf) ==  4'h6); // 0xc00000 - 0xc1ffff
...
//x2	Was a master bus as well
	...
	// # dlist = 2, nextlg(#dlist) = 1
	reg	[0:0]	r_wb_dio_bus_select;
	...
	always @(posedge i_clk)
	casez(wb_addr[0:0])
		1'b0: r_wb_dio_bus_select <= 1'd0;
		1'b1: r_wb_dio_bus_select <= 1'd1;
		default: r_wb_dio_bus_select <= 0;
	endcase

	always	@(posedge i_clk)
	casez(r_wb_dio_bus_select)
		1'd0: r_wb_dio_data <= bustimer_data;
...
`else	// SRAM_ACCESS
	...
	assign	sram_stall = 0;
	assign	sram_data  = 0;
	assign	sram_ack   = (wb_stb) && (sram_sel);
...
`ifdef	FLASHCFG_ACCESS
	...
	assign	flashcfg_stall = flash_stall;
