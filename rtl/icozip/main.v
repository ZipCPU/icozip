...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga autofpga -o . global.txt bkram.txt buserr.txt clock.txt pic.txt pwrcount.txt version.txt hbconsole.txt gpio.txt dlyarbiter.txt zipbones.txt spixpress.txt sramdev.txt
//
...
// check
	...
	// from
	localparam	RESET_ADDRESS = 32'h00a00000;
	//
...
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[22:19] &  4'hf) ==  4'h5); // 0xa00000 - 0xa000ff
...
//x2	Was a master bus as well
	...
	begin
		casez({		flash_cfg_ack,
			...
			6'b01????: wb_idata <= wb_dio_data;
			6'b001???: wb_idata <= console_data;
			6'b0001??: wb_idata <= wb_sio_data;
			6'b00001?: wb_idata <= bkram_data;
			6'b000001: wb_idata <= sram_data;
