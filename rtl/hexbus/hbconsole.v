...
module	hbconsole (
	...
	wbexec(
		// {{{
		i_clk, w_reset, iw_stb, iw_word, wb_busy,
		ow_stb, ow_word,
		o_wb_cyc, o_wb_stb, o_wb_we, o_wb_addr, o_wb_data,
			o_wb_sel, i_wb_stall, i_wb_ack, i_wb_err,
			i_wb_data
		// }}}
	);
	...
	genhex(
		// {{{
		i_clk, w_reset, hb_stb, hb_bits, hx_busy,
	...
	addnl(
		// {{{
		i_clk, w_reset, hx_stb, hx_byte, nl_busy,
